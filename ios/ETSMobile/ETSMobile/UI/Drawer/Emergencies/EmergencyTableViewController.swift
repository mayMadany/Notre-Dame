...
class EmergencyTableViewController: UITableViewController {
    ...
    override func viewDidLoad() {
        super.viewDidLoad()
        emergencyCallLabel!.attributedText = NSMutableAttributedString(
        ...
        internCallLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "internCall",
                comment: "From inside campus"
            )
        )
        extensionLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "extension",
                comment: "Ext. 55"
            )
        )
        bombThreatLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "bombThreat",
                comment: "Bomb threat"
            )
        )
        suspiciousPackageLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "suspiciousPackage",
                comment: "Suspicious package"
            )
        )
        fireLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "fire",
                comment: "Fire"
            )
        )
        suspiciousSmellLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "suspiciousSmell",
                comment: "Suspicious smell"
            )
        )
        elevatorMalfunctionLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "elevatorMalfunction",
                comment: "Elevator malfunction"
            )
        )
        powerOutageLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "powerOutage",
                comment: "Power outage"
            )
        )
        armedPersonLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "armedPerson",
                comment: "Armed person"
            )
        )
        medicalEmergencyLabel!.attributedText = NSMutableAttributedString(
            string: NSLocalizedString(
                "medicalEmergency",
